...
type AmIConnected struct {
	...
	MullvadExitIpHostname *string `json:"mullvad_exit_ip_hostname,omitempty,omitzero" yaml:"mullvad_exit_ip_hostname,omitempty" mapstructure:"mullvad_exit_ip_hostname,omitempty"`
